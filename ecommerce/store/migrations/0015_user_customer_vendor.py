...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('store', '0014_alter_order_customer_alter_shippingaddress_customer_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('PNS', 'Prefer not to say')], max_length=7, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Vendor',
